...
export default function QdrantBrowser() {
  ...
  return (
    <div className="flex h-[calc(100vh-12rem)]">
      ...
      <div className="w-64 bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 overflow-y-auto rounded-l-lg">
