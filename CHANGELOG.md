...
### Fixed
- Fixed WebSocket connection error in dashboard
- Added missing Nginx WebSocket proxy configuration for `/ws` endpoint
- Resolved "Connection Error" status indicator showing despite working API calls
